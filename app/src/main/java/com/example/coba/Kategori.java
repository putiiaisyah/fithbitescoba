        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (item.getItemId() == R.id.nav_home) {
                    ...
                    Intent homeIntent = new Intent(Kategori.this, Home.class);
                    startActivity(homeIntent);
                    return true;
                } else if (item.getItemId() == R.id.nav_artikel) {
                    // Navigasi ke Artikel activity
                    Intent artikelIntent = new Intent(Kategori.this, DetailArtikel.class);
                    startActivity(artikelIntent);
                    return true;
                } else if (item.getItemId() == R.id.nav_profil) {
                    // Menampilkan Toast jika Kategori dipilih
                    Toast.makeText(Kategori.this, "You are already in Kategori", Toast.LENGTH_SHORT).show();
                    return true;
                }
