        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (item.getItemId() == R.id.nav_home) {
                    ...
                    Intent artikelIntent = new Intent(KategoriLaut.this, DetailArtikel.class);
                    startActivity(artikelIntent);
                    return true;
                } else if (item.getItemId() == R.id.nav_profil) {
                    // Menampilkan Toast jika Kategori dipilih
                    Toast.makeText(KategoriLaut.this, "You are already in Kategori", Toast.LENGTH_SHORT).show();
                    return true;
                }
